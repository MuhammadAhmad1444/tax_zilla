...
export const BLOG_POSTS = [
  ...
  /* ═══════════════════════════════════════════════════════
     11. FBR INCOME TAX RETURN FILING 2025-26
  ═══════════════════════════════════════════════════════ */
  {
    id: 11,
    slug: 'how-to-file-income-tax-return-pakistan-2025',
    title: 'How to File Your Income Tax Return in Pakistan 2025–26: Step-by-Step FBR Iris Guide',
    excerpt: 'Filing your annual income tax return is mandatory for all NTN holders. This complete guide walks you through logging into FBR Iris, declaring income, completing your wealth statement, and submitting before the 30 September deadline.',
    category: 'income-tax',
    author: 'Tax Zilla Team',
    date: 'May 12, 2026',
    readTime: '10 min read',
    ...
    tags: ['Income Tax Return', 'FBR Iris', 'Filing', 'ATL'],
    toc: ['Who Must File?', 'Filing Deadline', 'Documents Needed', 'Step-by-Step Filing on Iris', 'Completing the Wealth Statement', 'Common Errors to Avoid'],
    keyTakeaways: [
      'Annual return filing deadline is 30 September for individuals',
      'Filing keeps you on the Active Taxpayer List and halves withholding tax rates',
      'The wealth statement must reconcile with all your assets and liabilities',
      'Late filing attracts a penalty of Rs. 1,000 per day up to Rs. 50,000',
      'You can revise your return within 5 years if you discover an error',
    ],
    contentBlocks: [
      { type: 'intro', text: 'Filing your annual income tax return is one of the most important financial actions you can take. It keeps you on the ATL, reduces withholding tax, and protects you from FBR notices. Here is exactly how to do it.' },
      { type: 'h2', text: 'Who Must File an Income Tax Return?' },
      { type: 'ul', items: [
        'Any person whose taxable income exceeds the exempt threshold (Rs. 600,000 for salaried)',
        'All NTN holders — even if income is zero, a nil return must be filed',
        'Company directors and shareholders',
        'Anyone who owns immovable property',
        'Anyone who owns a vehicle with engine capacity above 1000cc',
        'Persons who have paid utility bills of Rs. 500,000 or more in the year',
      ]},
      { type: 'h2', text: 'Filing Deadline' },
      { type: 'p', text: 'For individuals (salaried, business): 30 September of each year. For companies: 31 December. Missing the deadline attracts a penalty of Rs. 1,000 per day (capped at Rs. 50,000), plus a surcharge to get back on the ATL.' },
      { type: 'h2', text: 'Documents You Need Before Filing' },
      { type: 'ul', items: [
        'Salary certificates or payslips from all employers during the year',
        'Bank statements for all accounts held during the tax year',
        'Details of rental income received (if any)',
        'Business profit & loss accounts (if self-employed)',
        'Property purchase/sale documents (if any transactions occurred)',
        'Withholding tax certificates from bank, employer, and other deductors',
        'Details of all assets owned (property, vehicles, investments, savings)',
      ]},
      { type: 'h2', text: 'Step-by-Step Filing Process on FBR Iris' },
      { type: 'ol', items: [
        'Log in to iris.fbr.gov.pk using your NTN/CNIC and password',
        'From the left menu, select "Declaration" then "Income Tax Return"',
        'Choose the correct tax year (e.g., 2025 for the year ending 30 June 2025)',
        'Select your return type: "Original Return"',
        'Declare all income sources: Salary, Business Income, Rental, Dividends',
        'Enter all withholding taxes paid during the year (auto-populated in many cases)',
        'Complete the Wealth Reconciliation Statement (all assets and liabilities)',
        'Review the computed tax liability — pay any balance due via PSID',
        'Click Submit — your return is filed and acknowledgement is generated',
      ]},
      { type: 'callout', text: 'Pro Tip: Before filing, download your pre-populated data from FBR using the "Pre-Populated Return" option. This auto-fills salary and withholding data from employer and bank records, saving significant time.' },
      { type: 'h2', text: 'Common Mistakes That Cause FBR Notices' },
      { type: 'ul', items: [
        'Not declaring rental income — FBR cross-references property records',
        'Leaving the wealth statement incomplete or inconsistent',
        'Not including bank profit (interest income) in the return',
        'Declaring the wrong income type (salary as business or vice versa)',
        'Forgetting to include all properties and vehicles in the wealth statement',
      ]},
    ],
  },

  /* ═══════════════════════════════════════════════════════
     12. SUPER TAX PAKISTAN
  ═══════════════════════════════════════════════════════ */
  {
    id: 12,
    slug: 'super-tax-pakistan-2025-26',
    title: 'Super Tax in Pakistan 2025–26: Who Pays, Rates & How to Calculate',
    excerpt: 'Super Tax under Section 4C of the Income Tax Ordinance applies to high-income businesses and individuals earning above Rs. 150 million. This guide explains the rates, applicability, banking company surtax, and how to minimize liability.',
    category: 'income-tax',
    author: 'Tax Zilla Team',
    date: 'May 1, 2026',
    readTime: '7 min read',
    featured: false,
    image: 'https://images.unsplash.com/photo-1633158829875-e5316a358c6f?auto=format&fit=crop&w=1200&q=80',
    tags: ['Super Tax', 'Section 4C', 'High Income', 'Corporate Tax'],
    toc: ['What is Super Tax?', 'Super Tax Rates 2025-26', 'Who is Exempt?', 'Calculation Example', 'Banking Companies Surtax', 'Planning Strategies'],
    keyTakeaways: [
      'Super Tax applies to income exceeding Rs. 150 million at rates from 1% to 10%',
      'Banking companies pay an additional 4% surtax on top of regular corporate tax',
      'Super Tax is computed on income before certain deductions',
      'It applies to both companies and individuals with very high income',
      'Proper tax planning can legally reduce super tax exposure',
    ],
    contentBlocks: [
      { type: 'intro', text: 'Super Tax was introduced to ensure high-income earners contribute more to the national exchequer. If your business or personal income exceeds Rs. 150 million, you need to understand exactly how Super Tax applies.' },
      { type: 'h2', text: 'Super Tax Rates for FY 2025–26' },
      { type: 'table', headers: ['Income Bracket', 'Super Tax Rate'], rows: [
      ...
      { type: 'callout', text: 'Important: Super Tax is applied on the entire income of the bracket — not just the portion exceeding the threshold. This creates cliff-edge effects that require careful tax planning.' },
      { type: 'h2', text: 'Who is Exempt from Super Tax?' },
      { type: 'ul', items: [
        'Individuals and companies with taxable income below Rs. 150 million',
        'Agricultural income (which has its own provincial tax framework)',
        'Non-profit organizations meeting FBR criteria',
        'Certain export-oriented sectors — subject to policy changes',
      ]},
      { type: 'h2', text: 'Banking Companies — Additional Surtax' },
      { type: 'p', text: 'Banking companies face an additional burden beyond the standard corporate tax rate. They pay a 4% surtax on their taxable income, bringing their effective tax rate to 43% in many cases. This was introduced to capture windfall profits in the banking sector.' },
      { type: 'h2', text: 'Legal Ways to Reduce Super Tax Exposure' },
      { type: 'ul', items: [
        'Optimize timing of income recognition across tax years where permissible',
        'Maximize allowable deductions — depreciation, research & development costs',
        'Utilize group relief provisions if part of a corporate group',
        'Invest in REIT, infrastructure, or other tax-incentivised sectors',
        'Consult a tax advisor before the year-end to implement planning strategies',
      ]},
    ],
  },

  /* ═══════════════════════════════════════════════════════
     13. PUNJAB SALES TAX ON SERVICES (PRA)
  ═══════════════════════════════════════════════════════ */
  {
    id: 13,
    slug: 'punjab-sales-tax-services-pra-guide',
    title: 'Punjab Sales Tax on Services (PRA) 2025: Registration, Rates & Monthly Filing',
    excerpt: 'If you provide services in Punjab — IT, consulting, catering, construction, or advertising — you are likely liable for Punjab Sales Tax on Services collected by the Punjab Revenue Authority (PRA). Here is the complete guide.',
    category: 'sales-tax',
    author: 'Tax Zilla Team',
    date: 'Apr 18, 2026',
    readTime: '8 min read',
    ...
    tags: ['PRA', 'Punjab Sales Tax', 'Services Tax', 'Provincial Tax'],
    toc: ['What is Punjab Sales Tax on Services?', 'Who Must Register with PRA?', 'Key Service Tax Rates', 'IT & Software Services — Special Rates', 'Monthly Return Filing', 'PRA vs FBR — Which Authority?'],
    keyTakeaways: [
      'Punjab Sales Tax on Services is levied at 16% on most taxable services',
      'IT and IT-enabled services enjoy a reduced rate of 5% under PRA',
      'Monthly returns must be filed by the 15th of the following month',
      'Service providers in Punjab must register with PRA (not FBR) for service tax',
      'Penalties for non-compliance can reach 100% of the tax amount',
    ],
    contentBlocks: [
      { type: 'intro', text: 'Provincial Sales Tax on Services is a significant tax obligation for businesses operating in Punjab. Unlike FBR which covers goods, PRA (Punjab Revenue Authority) handles services tax in Punjab.' },
      { type: 'h2', text: 'What is Punjab Sales Tax on Services?' },
      { type: 'p', text: 'Punjab Sales Tax on Services (PSTS) is levied under the Punjab Sales Tax on Services Act 2012. It applies to a wide range of services provided in Punjab, with the standard rate of 16% applicable to most services.' },
      { type: 'h2', text: 'Who Must Register with PRA?' },
      { type: 'ul', items: [
        'Consulting and advisory firms',
        'IT and software development companies (at reduced 5% rate)',
        'Advertising and marketing agencies',
        'Hotel and restaurant services above a certain threshold',
        'Construction and engineering services',
        'Logistics and freight forwarding companies',
        'Educational institutions (select categories)',
      ]},
      { type: 'h2', text: 'Key Service Tax Rates Under PRA' },
      { type: 'table', headers: ['Service Category', 'PRA Tax Rate'], rows: [
        ['Standard taxable services', '16%'],
        ['IT & IT-enabled services', '5%'],
        ['Restaurants (non-corporate, limited)', '5%'],
        ['Construction services', '16%'],
        ['Advertising services', '16%'],
        ['Courier and logistics', '16%'],
        ['Legal services', '16%'],
      ]},
      { type: 'callout', text: 'Good News for IT: Software development, web development, app development, and IT consulting are taxed at only 5% under PRA — compared to 16% for other services. Ensure you correctly classify your service type.' },
      { type: 'h2', text: 'Monthly Filing — Deadlines & Process' },
      { type: 'ul', items: [
        'Monthly sales tax return is due by the 15th of each month',
        'Returns are filed on the PRA e-portal (pra.punjab.gov.pk)',
        'Declare all taxable services provided in the previous month',
        'Input tax credit available on purchases used in providing taxable services',
        'Payment can be made through bank challan or online banking',
      ]},
    ],
  },

  /* ═══════════════════════════════════════════════════════
     14. E-COMMERCE TAX PAKISTAN
  ═══════════════════════════════════════════════════════ */
  {
    id: 14,
    slug: 'ecommerce-tax-obligations-pakistan-2025',
    title: 'E-Commerce & Online Business Tax in Pakistan 2025: What You Must Know',
    excerpt: 'Running an online store, dropshipping business, or selling on Daraz? Pakistan has specific tax rules for e-commerce sellers including withholding tax obligations, sales tax on digital services, and income tax on online revenues.',
    category: 'business',
    author: 'Tax Zilla Team',
    date: 'Apr 10, 2026',
    readTime: '8 min read',
    ...
    tags: ['E-Commerce', 'Online Business', 'Daraz', 'Digital Tax'],
    toc: ['Is E-Commerce Taxable in Pakistan?', 'Income Tax on Online Sales', 'Sales Tax for Online Sellers', 'Withholding Tax — Section 236Y', 'Marketplace Sellers (Daraz, etc.)', 'Dropshipping Tax Rules'],
    keyTakeaways: [
      'All e-commerce income is fully taxable under Pakistan income tax law',
      'Section 236Y imposes withholding tax on amounts collected by digital marketplace operators',
      'Online sellers exceeding Rs. 10 million turnover must register for sales tax',
      'Foreign e-commerce platforms (Amazon, eBay) are subject to digital services tax',
      'Maintaining proper invoices and records is essential for e-commerce compliance',
    ],
    contentBlocks: [
      { type: 'intro', text: 'Pakistan\'s e-commerce sector has grown explosively. But with growth comes tax obligations that many online sellers are unaware of. Whether you sell on Daraz, run a Shopify store, or import products for resale — here is what you need to know.' },
      { type: 'h2', text: 'Is E-Commerce Income Taxable in Pakistan?' },
      { type: 'p', text: 'Yes — absolutely. Income from online businesses is fully taxable under the Income Tax Ordinance 2001. There is no exemption for online or digital businesses. Your income must be declared in your annual FBR return regardless of how it is earned.' },
      { type: 'h2', text: 'Section 236Y — Withholding on Digital Transactions' },
      { type: 'p', text: 'Section 236Y requires digital marketplace operators (like Daraz, Foodpanda, Careem) to withhold tax from payments made to their sellers and service providers:' },
      { type: 'table', headers: ['Seller Type', 'Withholding Rate'], rows: [
        ['Filer (on ATL)', '1%'],
        ['Non-Filer (not on ATL)', '2%'],
      ]},
      { type: 'h2', text: 'Sales Tax for E-Commerce Sellers' },
      { type: 'ul', items: [
        'If your annual turnover from online sales exceeds Rs. 10 million, you must register for Sales Tax with FBR',
        'Manufacturers selling online must register regardless of turnover',
        'Standard GST rate on goods is 18%',
        'Input tax credit is available on business purchases',
      ]},
      { type: 'callout', text: 'Digital Services Tax: Foreign digital service providers (Netflix, Zoom, Google Ads, etc.) are required to register for Pakistani GST and charge 18% on services to Pakistani users. If you purchase these services for your business, you may be able to claim input tax credit.' },
      { type: 'h2', text: 'Dropshipping — Tax Treatment' },
      { type: 'p', text: 'Dropshipping (selling products without holding inventory) is a popular model. In Pakistan, the income from dropshipping is taxable as business income. If you are dropshipping to international customers, the income should be declared as export income and may qualify for reduced tax rates under Clause 133 if it involves IT-related products or services.' },
    ],
  },

  /* ═══════════════════════════════════════════════════════
     15. SALARY TAX SAVING TIPS
  ═══════════════════════════════════════════════════════ */
  {
    id: 15,
    slug: 'salary-tax-saving-tips-pakistan-2025',
    title: '10 Legal Ways to Reduce Your Salary Tax in Pakistan 2025–26',
    excerpt: 'As a salaried individual, you have more tax-saving options than you think. From pension contributions to Zakat deductions and housing loan interest, discover 10 legal strategies to reduce your income tax liability in FY 2025–26.',
    category: 'income-tax',
    author: 'Tax Zilla Team',
    date: 'Mar 25, 2026',
    readTime: '9 min read',
    ...
    tags: ['Tax Saving', 'Salary Tax', 'Deductions', 'Tax Planning'],
    toc: ['Why Salary Tax Planning Matters', 'Zakat Deduction', 'Pension & Provident Fund', 'Housing Loan Interest', 'Charitable Donations', 'Medical Allowance', 'Education Expense', 'Investment Deductions'],
    keyTakeaways: [
      'Zakat paid during the year is fully deductible from taxable income',
      'Contributions to approved pension funds reduce taxable salary',
      'Housing loan interest up to Rs. 2 million is deductible',
      'Donations to approved institutions qualify for a 30% income tax deduction',
      'Proactive tax planning before year-end can save lakhs in tax',
    ],
    contentBlocks: [
      { type: 'intro', text: 'Many salaried Pakistanis overpay their income tax simply because they are unaware of the deductions and exemptions available to them under the Income Tax Ordinance. Here are 10 completely legal strategies to reduce your tax bill.' },
      { type: 'h2', text: '1. Claim Your Zakat Deduction' },
      { type: 'p', text: 'Zakat deducted from your bank account or paid voluntarily to approved institutions is fully deductible from your taxable income. Ensure you obtain a zakat deduction certificate from your bank and include it in your FBR return.' },
      { type: 'h2', text: '2. Maximize Pension Fund Contributions' },
      { type: 'p', text: 'Contributions to an approved pension fund or provident fund are deductible from taxable income. The deduction is available for amounts contributed during the tax year.' },
      { type: 'h2', text: '3. Claim Housing Loan Interest Deduction' },
      { type: 'p', text: 'If you have taken a mortgage or housing finance loan, the markup/interest paid on it is deductible from your taxable income — up to Rs. 2 million per year. This is one of the most valuable deductions available to salaried homeowners.' },
      { type: 'h2', text: '4. Donate to Approved Charitable Institutions' },
      { type: 'p', text: 'Donations to organizations approved by the Commissioner under Section 61 qualify for a deduction of up to 30% of your taxable income. Receipts from recognized organizations like EDHI, Shaukat Khanum, and similar institutions are accepted.' },
      { type: 'h2', text: '5. Education Expense Allowance' },
      { type: 'p', text: 'Tuition fees paid for children at educational institutions are deductible up to Rs. 60,000 per child (with a maximum of Rs. 150,000 per year). Keep fee receipts from the school or institution.' },
      { type: 'ul', items: [
        'Maximum deduction: Rs. 60,000 per child, up to Rs. 150,000 total',
        'Must be a recognized educational institution',
        'Fee receipts must be kept for potential audit',
      ]},
      { type: 'callout', text: 'Action Point: Before 30 June each year, review all your deductible expenses. Many salaried employees leave significant tax savings unclaimed simply by not tracking their qualifying payments.' },
      { type: 'h2', text: '6. Invest in Registered Mutual Funds or Shares' },
      { type: 'p', text: 'Investment in shares of a listed company or units of an open-end mutual fund qualifies for a tax credit of 15% of the investment amount, subject to a maximum of Rs. 1 million invested.' },
    ],
  },

  /* ═══════════════════════════════════════════════════════
     16. UK TAX FOR PAKISTANI EXPATS
  ═══════════════════════════════════════════════════════ */
  {
    id: 16,
    slug: 'uk-tax-guide-pakistani-expats-2025',
    title: 'UK Tax Guide for Overseas Pakistanis 2025: Income Tax, NIC & Pakistan DTA',
    excerpt: 'Thousands of Pakistanis live and work in the UK. Whether you are employed, self-employed, or running a business, understanding UK income tax, National Insurance, the Pakistan-UK DTA, and your Pakistani filing obligations is essential.',
    category: 'international',
    author: 'Tax Zilla Team',
    date: 'Apr 5, 2026',
    readTime: '9 min read',
    ...
    tags: ['UK Tax', 'British Pakistanis', 'HMRC', 'Double Taxation'],
    toc: ['UK Tax Residency Rules', 'UK Income Tax Rates 2025', 'National Insurance Contributions', 'Pakistan-UK Double Taxation Agreement', 'Pakistani Assets — UK Obligations', 'Filing in Both Countries'],
    keyTakeaways: [
      'You are a UK tax resident if you spend 183+ days in the UK in a tax year',
      'UK income tax rates range from 20% to 45% depending on income level',
      'The Pakistan-UK DTA prevents the same income from being taxed twice',
      'Pakistani assets (property, investments) may need to be declared to HMRC',
      'UK tax year runs from 6 April to 5 April — different from Pakistan\'s July-June year',
    ],
    contentBlocks: [
      { type: 'intro', text: 'Over 1.5 million Pakistanis live in the United Kingdom, many of them with financial ties to both countries. Managing your tax position across two jurisdictions requires understanding both UK and Pakistani tax law.' },
      { type: 'h2', text: 'UK Tax Residency — The Statutory Residence Test' },
      { type: 'p', text: 'HMRC uses the Statutory Residence Test (SRT) to determine whether you are a UK tax resident. Generally, spending 183 or more days in the UK makes you a UK resident. Split-year rules apply when you move to or from the UK.' },
      { type: 'h2', text: 'UK Income Tax Rates 2025–26' },
      { type: 'table', headers: ['Income Band', 'Tax Rate'], rows: [
        ['Up to £12,570 (Personal Allowance)', '0%'],
        ['£12,571 – £50,270 (Basic Rate)', '20%'],
        ['£50,271 – £125,140 (Higher Rate)', '40%'],
        ['Above £125,140 (Additional Rate)', '45%'],
      ]},
      { type: 'h2', text: 'National Insurance Contributions (NIC)' },
      { type: 'p', text: 'In addition to income tax, employed and self-employed persons in the UK pay National Insurance. NIC funds state pension and other benefits. Key rates: Employee Class 1 NIC: 8% on earnings between £12,570 and £50,270.' },
      { type: 'h2', text: 'Pakistan-UK Double Taxation Agreement' },
      { type: 'p', text: 'The Pakistan-UK DTA prevents you from paying tax on the same income in both countries. Key provisions:' },
      { type: 'ul', items: [
        'Rental income from Pakistani property: taxable in Pakistan, but credit given in UK',
        'Salary earned in UK: taxable in UK only (if you work in UK)',
        'Dividends from Pakistani companies: taxed at source in Pakistan at reduced DTA rate',
        'You can claim Foreign Tax Credit in the UK for tax paid in Pakistan',
      ]},
      { type: 'h2', text: 'Declaring Pakistani Assets to HMRC' },
      { type: 'p', text: 'If you are a UK tax resident, HMRC requires you to declare worldwide income and certain overseas assets. Pakistani rental income, dividends, and capital gains may need to be reported on your UK Self Assessment tax return.' },
      { type: 'callout', text: 'HMRC has significantly increased scrutiny of overseas assets. Failure to declare Pakistani income and assets can result in substantial penalties. If you have not previously declared Pakistani income, consider using the HMRC Worldwide Disclosure Facility.' },
    ],
  },

  /* ═══════════════════════════════════════════════════════
     17. BUILDERS & DEVELOPERS TAX
  ═══════════════════════════════════════════════════════ */
  {
    id: 17,
    slug: 'builders-developers-tax-pakistan-2025',
    title: 'Builders & Developers Tax in Pakistan 2025–26: Fixed Tax Regime Explained',
    excerpt: 'Pakistani builders and property developers are taxed under a special Fixed Tax Regime with area-based rates rather than profit-based rates. This guide explains how the scheme works, per-square-foot tax rates, and registration requirements.',
    category: 'property',
    author: 'Tax Zilla Team',
    date: 'Mar 18, 2026',
    readTime: '8 min read',
    ...
    tags: ['Builder Tax', 'Developer Tax', 'Fixed Tax', 'Construction'],
    toc: ['What is the Builder/Developer Fixed Tax Regime?', 'Tax Rates by City & Area', 'Developer vs Builder — Key Differences', 'Registration Requirements', 'Filing Obligations', 'Benefits of the FTR'],
    keyTakeaways: [
      'Builders and developers pay a fixed tax per square foot instead of profit-based tax',
      'Tax rates vary by city category and project type (residential vs commercial)',
      'Registration with FBR as a builder/developer is mandatory',
      'The fixed tax regime simplifies compliance and provides tax certainty',
      'Developers must pay quarterly instalments based on project progress',
    ],
    contentBlocks: [
      { type: 'intro', text: 'Pakistan\'s construction and real estate sector is one of the largest contributors to the economy. The government introduced a Fixed Tax Regime (FTR) for builders and developers to simplify their tax obligations and encourage sector growth.' },
      { type: 'h2', text: 'The Fixed Tax Regime — How It Works' },
      { type: 'p', text: 'Under the FTR, builders and developers pay tax on a per-square-foot basis instead of on their actual profits. This provides certainty, reduces dispute with FBR, and simplifies record-keeping.' },
      { type: 'h2', text: 'Tax Rates by City Category (FY 2025–26)' },
      { type: 'table', headers: ['City Category', 'Residential (per sq ft)', 'Commercial (per sq ft)'], rows: [
        ['Category A (Karachi, Lahore, Islamabad)', 'Rs. 210', 'Rs. 290'],
        ['Category B (Hyderabad, Faisalabad, Multan)', 'Rs. 160', 'Rs. 225'],
        ['Category C (Other cities)', 'Rs. 105', 'Rs. 145'],
      ]},
      { type: 'h2', text: 'Builder vs Developer — Key Differences' },
      { type: 'ul', items: [
        'Builder: Constructs buildings on land owned by others and sells under construction contracts',
        'Developer: Acquires land, develops it, and sells plots or completed units',
        'Both are covered under the FTR but have different registration categories',
        'Developer\'s land cost is excluded from the area for tax calculation',
      ]},
      { type: 'h2', text: 'Registration & Quarterly Payment' },
      { type: 'p', text: 'Builders and developers must register with FBR and submit a project completion certificate. Tax is payable in quarterly instalments linked to project milestones. Failure to register and pay on time attracts significant penalties and can lead to FBR sealing of the project.' },
      { type: 'callout', text: 'Important: The FTR is a final tax for eligible builders and developers. You cannot claim input adjustments or deductions on top of the fixed tax. However, if your actual profit is lower than the FTR amount, the FTR still applies.' },
    ],
  },

  /* ═══════════════════════════════════════════════════════
     18. IT SECTOR TAX BENEFITS
  ═══════════════════════════════════════════════════════ */
  {
    id: 18,
    slug: 'it-sector-tax-benefits-pakistan-2025',
    title: 'IT Sector Tax Exemptions & Benefits in Pakistan 2025: Complete IT Company Guide',
    excerpt: 'Pakistan\'s IT sector enjoys some of the most generous tax benefits in any industry — including zero income tax on IT exports, reduced withholding rates, and PTA/PSEB registration benefits. Here is how to maximize them.',
    category: 'freelancer',
    author: 'Tax Zilla Team',
    date: 'Mar 10, 2026',
    readTime: '10 min read',
    ...
    tags: ['IT Sector', 'Tax Exemption', 'PSEB', 'IT Exports', 'Software Companies'],
    toc: ['IT Export Tax Benefits Overview', 'Zero Tax on IT Exports', 'PSEB Registration Advantages', 'Sales Tax Exemptions for IT', 'Custom Duty Relief on IT Equipment', 'How to Qualify & Apply'],
    keyTakeaways: [
      'IT exports from Pakistan are effectively taxed at 0.25% under Clause 133',
      'PSEB-registered companies gain official IT exporter status and additional benefits',
      'Software development and IT services are exempt from FBR sales tax',
      'PRA taxes IT services at 5% vs 16% for other services in Punjab',
      'Import of IT equipment qualifies for duty concessions under various SROs',
    ],
    contentBlocks: [
      { type: 'intro', text: 'Pakistan has deliberately created a tax-friendly environment for the IT industry to compete globally and grow exports. If you run an IT company or work as an IT freelancer, these benefits can dramatically reduce your tax burden — legally.' },
      { type: 'h2', text: 'IT Export Income — Effectively Zero Tax' },
      { type: 'p', text: 'Under Clause 133 of the Second Schedule to the Income Tax Ordinance, income from export of IT and IT-enabled services is taxed at 0.25% of export proceeds. For practical purposes, with standard deductions and tax planning, effective rates can approach zero.' },
      { type: 'ul', items: [
        'Applies to software development, IT consulting, BPO, data analytics, content moderation',
        'Income must be received through Pakistan banking channels',
        'Company must be registered with FBR and maintain proper records',
        'PSEB registration strengthens the claim to the reduced rate',
        'Rate applies on gross export receipts (not just profit)',
      ]},
      { type: 'h2', text: 'FBR Sales Tax Exemption for IT Services' },
      { type: 'p', text: 'IT services are specifically exempt from FBR federal Sales Tax. This means IT companies do not need to charge 18% GST on their services invoices. This makes Pakistani IT firms more competitive internationally.' },
      { type: 'h2', text: 'PSEB Registration — Process & Benefits' },
      { type: 'ol', items: [
        'Apply on the PSEB portal (pseb.org.pk) with company documents',
        'Submit NTN, SECP registration certificate, and business details',
        'Provide samples of IT work or contracts as proof of IT business',
        'PSEB issues a registration certificate within 2–4 weeks',
        'Benefits include government facilitation, grants access, and official IT exporter status',
      ]},
      { type: 'h2', text: 'Custom Duty Relief on IT Equipment' },
      { type: 'p', text: 'IT companies can import computers, servers, networking equipment, and software under concessional duty rates or full exemption under various FBR SROs. This significantly reduces the cost of building out technology infrastructure in Pakistan.' },
      { type: 'callout', text: 'Competitive Advantage: A Pakistani IT company effectively exporting at 0.25% income tax rate vs a standard business at 29% corporate tax rate has a massive competitive advantage. Proper structuring and registration can unlock all these benefits.' },
    ],
  },

  /* ═══════════════════════════════════════════════════════
     19. COMPANY ANNUAL COMPLIANCE
  ═══════════════════════════════════════════════════════ */
  {
    id: 19,
    slug: 'company-annual-compliance-pakistan-2025',
    title: 'Annual Compliance for Pakistani Companies 2025: SECP & FBR Filings Checklist',
    excerpt: 'Running a private limited company in Pakistan comes with mandatory annual compliance obligations to both SECP and FBR. Miss these deadlines and face penalties, company striking off, or director disqualification. Here is your complete checklist.',
    category: 'business',
    author: 'Tax Zilla Team',
    date: 'Feb 28, 2026',
    readTime: '8 min read',
    ...
    tags: ['Company Compliance', 'SECP', 'Form A', 'Corporate Filing'],
    toc: ['Why Annual Compliance Matters', 'SECP Form A — Annual Return', 'SECP Annual Accounts Filing', 'FBR Corporate Tax Return', 'Directors\' Responsibilities', 'Penalties for Non-Compliance'],
    keyTakeaways: [
      'Every Pvt Ltd company must file SECP Form A within 30 days of each AGM',
      'Annual audited accounts must be filed with SECP within 6 months of year-end',
      'FBR corporate income tax return is due by 31st December',
      'Company directors face personal liability for non-compliance penalties',
      'Non-filing companies can be struck off the SECP register',
    ],
    contentBlocks: [
      { type: 'intro', text: 'Registering a company is just the beginning. The real work of compliance starts after incorporation. Every Pakistani Pvt Ltd company has mandatory annual obligations to both SECP and FBR — failure to comply can have serious consequences.' },
      { type: 'h2', text: 'SECP Form A — Annual Return' },
      { type: 'p', text: 'Form A (Annual Return) is the most fundamental SECP filing. It must be submitted to SECP within 30 days of the Annual General Meeting (AGM). The form confirms the company\'s registered details, directors, shareholders, and share capital.' },
      { type: 'ul', items: [
        'Required information: list of directors, shareholders, registered office address, share capital',
        'Form A must be filed within 30 days of the AGM',
        'AGM must be held within 4 months of the financial year end',
        'Late filing penalty: Rs. 500 per day for each day of default',
      ]},
      { type: 'h2', text: 'Annual Accounts & Audit Submission' },
      { type: 'p', text: 'Audited financial statements must be submitted to SECP within 6 months of the financial year end. The accounts must be prepared in accordance with approved accounting standards (IFRS or AFRS as applicable).' },
      { type: 'h2', text: 'FBR Corporate Income Tax Return' },
      { type: 'p', text: 'Every company must file its income tax return with FBR. The deadline is 31st December for companies with a financial year ending 30 June. Key requirements:' },
      { type: 'ul', items: [
        'File income tax return on FBR Iris portal',
        'Attach audited financial statements (or accounts)',
        'Declare all income, deductions, and tax payments',
        'Pay any balance corporate tax (29% of taxable income)',
        'Advance tax must be paid quarterly during the year',
      ]},
      { type: 'h2', text: 'Annual Compliance Calendar' },
      { type: 'table', headers: ['Deadline', 'Filing Required', 'Authority'], rows: [
        ['Within 4 months of year-end', 'Annual General Meeting (AGM)', 'SECP'],
        ['Within 30 days of AGM', 'Form A (Annual Return)', 'SECP'],
        ['Within 6 months of year-end', 'Audited Accounts', 'SECP'],
        ['31 December', 'Corporate Income Tax Return', 'FBR'],
        ['15th of each month', 'Monthly WHT Statements', 'FBR'],
        ['18th of each month', 'Sales Tax Return (if registered)', 'FBR'],
      ]},
      { type: 'callout', text: 'Tax Zilla manages all annual compliance for companies on an ongoing basis — including SECP filings, audit coordination, and FBR return preparation. Contact us to outsource your compliance entirely.' },
    ],
  },

  /* ═══════════════════════════════════════════════════════
     20. SAUDI ARABIA TAX FOR PAKISTANIS
  ═══════════════════════════════════════════════════════ */
  {
    id: 20,
    slug: 'saudi-arabia-tax-pakistani-workers-2025',
    title: 'Saudi Arabia Tax Guide for Pakistani Workers & Businesses 2025',
    excerpt: 'Saudi Arabia introduced VAT at 15% and Zakat obligations for businesses. Pakistani workers, professionals, and businesses operating in the Kingdom need to understand their tax position in both Saudi Arabia and Pakistan.',
    category: 'international',
    author: 'Tax Zilla Team',
    date: 'Feb 20, 2026',
    readTime: '8 min read',
    ...
    tags: ['Saudi Arabia', 'KSA Tax', 'VAT', 'Pakistani Workers'],
    toc: ['Saudi Arabia Tax System Overview', 'No Personal Income Tax in KSA', 'Saudi VAT at 15%', 'Zakat on Saudi Companies', 'Pakistan-KSA Double Taxation', 'Remittances to Pakistan'],
    keyTakeaways: [
      'Saudi Arabia has no personal income tax — Pakistani workers pay no income tax in KSA',
      'VAT in Saudi Arabia is 15% and applies to most goods and services',
      'Saudi companies pay Zakat (at 2.5%) and corporate income tax (20% for foreign firms)',
      'Pakistani workers still have FBR filing obligations on Pakistan-source income',
      'Remittances from Saudi Arabia to Pakistan are not taxable in Pakistan',
    ],
    contentBlocks: [
      { type: 'intro', text: 'Saudi Arabia remains the top destination for Pakistani overseas workers, with over 2.5 million Pakistanis employed in the Kingdom. Understanding the Saudi tax system and its interaction with Pakistani tax law is essential for workers and businesses alike.' },
      { type: 'h2', text: 'Saudi Arabia Tax System — Overview' },
      { type: 'p', text: 'Saudi Arabia has a relatively straightforward tax system for individuals. The key point: there is no personal income tax on wages and salaries. Pakistani workers in Saudi Arabia pay no income tax to the Saudi government on their employment income.' },
      { type: 'h2', text: 'Saudi VAT — 15%' },
      { type: 'p', text: 'Saudi Arabia introduced VAT in 2018 at 5%, which was increased to 15% in 2020. VAT applies to most goods and services. If you run a business in Saudi Arabia with taxable supplies above SAR 375,000, you must register for VAT with ZATCA (the Saudi tax authority).' },
      { type: 'h2', text: 'Corporate Tax & Zakat for Saudi Businesses' },
      { type: 'table', headers: ['Entity Type', 'Tax/Zakat Rate'], rows: [
        ['Saudi nationals & GCC nationals (business income)', 'Zakat at 2.5% of Zakat base'],
        ['Foreign companies & non-GCC nationals', 'Corporate Income Tax at 20%'],
        ['Mixed shareholding companies', 'Zakat on Saudi share + CIT on foreign share'],
        ['Oil & gas companies', 'Up to 85% (special rates)'],
      ]},
      { type: 'h2', text: 'Pakistan Tax Obligations for KSA Workers' },
      { type: 'p', text: 'Pakistani workers in Saudi Arabia are classified as Non-Resident Persons (NRPs) for Pakistan tax purposes if they spend less than 183 days in Pakistan. As NRPs:' },
      { type: 'ul', items: [
        'Saudi employment income is NOT taxable in Pakistan (foreign-source income of NRP)',
        'But Pakistani property income, dividends from Pakistani companies, and capital gains on Pakistani assets are taxable',
        'Filing a Pakistani return maintains ATL status and reduces property transaction tax',
        'Remittances sent to Pakistan are not income — they are exempt from Pakistani tax',
      ]},
      { type: 'callout', text: 'Practical Tip: Even if you are working in Saudi Arabia and have no taxable income in Pakistan, filing a Pakistani nil return (or return showing only Pakistani-source income) keeps you on the ATL and saves you money on your next property or vehicle transaction.' },
    ],
  },

  /* ═══════════════════════════════════════════════════════
     21. BUSINESS TAX SOLE PROPRIETORS
  ═══════════════════════════════════════════════════════ */
  {
    id: 21,
    slug: 'business-income-tax-sole-proprietor-pakistan',
    title: 'Income Tax for Sole Proprietors & Small Businesses in Pakistan 2025–26',
    excerpt: 'Are you a shopkeeper, trader, doctor, consultant, or small business owner? This guide explains business income tax slabs, advance tax obligations, quarterly payments, and record-keeping requirements for sole proprietors in Pakistan.',
    category: 'business',
    author: 'Tax Zilla Team',
    date: 'Feb 10, 2026',
    readTime: '9 min read',
    ...
    tags: ['Sole Proprietor', 'Business Tax', 'Small Business', 'Advance Tax'],
    toc: ['Business Income Tax Slabs', 'Advance Tax Obligations', 'Quarterly Payment Schedule', 'Deductible Business Expenses', 'Record-Keeping Requirements', 'Common Tax Mistakes'],
    keyTakeaways: [
      'Business income is taxed at higher rates than salaried income at the same level',
      'Advance tax must be paid quarterly if annual tax liability exceeds Rs. 1 million',
      'All business expenses must be documented with invoices and receipts',
      'Depreciation on business assets is an allowable deduction',
      'Proper accounts reduce the risk of FBR adding income under Section 111',
    ],
    contentBlocks: [
      { type: 'intro', text: 'Pakistan has millions of sole proprietors and small business owners — from shopkeepers and doctors to consultants and traders. Understanding your tax obligations is critical to avoiding costly FBR notices and penalties.' },
      { type: 'h2', text: 'Business Income Tax Slabs 2025–26' },
      { type: 'p', text: 'Unlike salaried individuals, business owners pay higher tax rates on the same income level. The following slabs apply to business individuals and AOPs:' },
      { type: 'table', headers: ['Annual Business Income', 'Tax Rate'], rows: [
        ['Up to Rs. 600,000', '0%'],
        ['Rs. 600,001 – Rs. 1,200,000', '15%'],
        ['Rs. 1,200,001 – Rs. 1,600,000', '20%'],
        ['Rs. 1,600,001 – Rs. 3,200,000', '30%'],
      ...
      { type: 'h2', text: 'Advance Tax — Quarterly Payment Obligation' },
      { type: 'p', text: 'If your annual tax liability exceeds Rs. 1 million, you must pay advance tax in four quarterly instalments:' },
      { type: 'table', headers: ['Quarter', 'Due Date', 'Payment Amount'], rows: [
        ['Q1 (Jul–Sep)', '25 September', '25% of annual liability'],
        ['Q2 (Oct–Dec)', '25 December', '25% of annual liability'],
        ['Q3 (Jan–Mar)', '25 March', '25% of annual liability'],
        ['Q4 (Apr–Jun)', '15 June', '25% of annual liability'],
      ]},
      { type: 'h2', text: 'Deductible Business Expenses' },
      { type: 'ul', items: [
        'Rent for business premises (with rental agreement)',
        'Salaries and wages paid to employees',
        'Depreciation on business assets (machinery, computers, vehicles)',
        'Utility bills (electricity, gas, internet) — business portion',
        'Cost of goods sold (purchases of inventory)',
        'Professional fees — accounting, legal, consulting',
        'Marketing and advertising expenses',
        'Bank charges and loan markup/interest (on business loans)',
      ]},
      { type: 'callout', text: 'Critical: FBR under Section 111 can add unexplained income to your assessment if your lifestyle or assets don\'t match your declared income. Maintaining proper accounts is your best protection against this.' },
    ],
  },

  /* ═══════════════════════════════════════════════════════
     22. DIVIDEND TAX PAKISTAN
  ═══════════════════════════════════════════════════════ */
  {
    id: 22,
    slug: 'dividend-tax-pakistan-2025-26',
    title: 'Dividend Tax in Pakistan 2025–26: Rates, WHT Deduction & How to Declare',
    excerpt: 'Dividends received from Pakistani companies are subject to withholding tax at source. This guide explains dividend tax rates for filers and non-filers, how to declare dividends in your return, and double taxation relief for overseas investors.',
    category: 'income-tax',
    author: 'Tax Zilla Team',
    date: 'Jan 25, 2026',
    readTime: '6 min read',
    featured: false,
    image: 'https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?auto=format&fit=crop&w=1200&q=80',
    tags: ['Dividend Tax', 'Withholding Tax', 'Shares', 'Investment Income'],
    toc: ['What is Dividend Tax?', 'Dividend Tax Rates 2025-26', 'Filer vs Non-Filer Rates', 'How Dividend WHT is Collected', 'Declaring Dividends in Your Return', 'Tax on REIT Dividends'],
    keyTakeaways: [
      'Dividend income is taxed at 15% for filers and 30% for non-filers',
      'Tax is withheld at source by the paying company — you receive the net amount',
      'Dividend tax is generally a final tax — not included in normal income slabs',
      'REITs distribute dividends which are taxed at special rates',
      'Being on the ATL halves your dividend withholding tax rate',
    ],
    contentBlocks: [
      { type: 'intro', text: 'If you own shares in a Pakistani company or receive dividends from mutual funds, you need to understand how dividend tax works. The good news: it is straightforward and largely handled automatically.' },
      { type: 'h2', text: 'Dividend Tax Rates FY 2025–26' },
      { type: 'table', headers: ['Investor Status', 'WHT Rate on Dividends'], rows: [
        ['Active Filer (on ATL)', '15%'],
        ['Non-Filer (not on ATL)', '30%'],
        ['Company receiving dividends from listed company', '15%'],
        ['REIT distribution to individual', '15% (filer)'],
      ]},
      { type: 'h2', text: 'Is Dividend Tax Final or Adjustable?' },
      { type: 'p', text: 'Dividend income is treated as a final tax for individuals — meaning the 15% or 30% WHT deducted by the company is your complete tax obligation on that income. You do not need to include it in your normal income for slab calculation purposes. However, you must still declare it in your wealth statement and return.' },
      { type: 'h2', text: 'How the Withholding Works' },
      { type: 'ol', items: [
        'Company declares dividend of Rs. 100 per share',
        'Company deducts WHT at 15% (if you are a filer) = Rs. 15',
        'You receive Rs. 85 net dividend in your bank account',
        'The company deposits Rs. 15 with FBR on your behalf',
        'You declare the Rs. 100 gross dividend in your FBR return (under dividend income)',
        'Rs. 15 already deposited counts as your complete tax on this income',
      ]},
      { type: 'h2', text: 'REIT Dividend Benefits' },
      { type: 'p', text: 'Real Estate Investment Trusts (REITs) listed on Pakistan Stock Exchange distribute dividends with favorable tax treatment. Investors in REITs benefit from regular income distributions from real estate assets at standard dividend withholding rates.' },
      { type: 'callout', text: 'Investment Tip: Dividend income from listed companies is taxed at a flat 15% for filers — significantly less than the 35% top income slab rate. For high-income individuals, investing in dividend-paying stocks is a tax-efficient strategy.' },
    ],
  },
];
